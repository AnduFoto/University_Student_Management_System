...
//                 alt={user.name || "User"}
//                 className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-black shadow-lg hover:scale-110 hover:shadow-xl transition-transform duration-300"
//               />
//             ) : (
...
//               <button
//                 onClick={logout}
//                 className="flex items-center text-center justify-center gap- w-full  py-2 text-red-600 hover:bg-red-100 hover:text-red-700 transition"
//               >
//                 <FaSignOutAlt />
//                 Logout
//               </button>
    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-white border-b border-slate-200 shadow-sm h-16">
      <div className="flex items-center justify-between h-full px-4 md:px-8">
        ...
        <div className="flex items-center gap-4 w-1/4">
          <div className="bg-orange-500 p-2 rounded-lg text-white hidden sm:block shadow-md">
        ...
        <div className="hidden md:flex items-center w-1/3 relative">
          ...
          <input 
            type="text" 
            placeholder="Search courses, results, materials..." 
            ...
            >
              <div className="relative">
                {user?.picture ? (
                  ...
                  <div className="w-9 h-9 bg-orange-100 text-orange-600 flex items-center justify-center rounded-lg">
                    <FaUser />
                  </div>
                )}
            ...
            {dropdownOpen && (
              ...
              >
                <div className="px-4 py-3 border-b border-slate-50">
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-widest">Portal Access</p>
                  <p className="text-sm text-slate-600 truncate mt-1">{user?.email || "student@university.edu"}</p>
                </div>
