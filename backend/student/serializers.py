...
#         child=serializers.CharField(),  # Accept string course IDs
#         write_only=True,
#         required=True
#     )
#     courses = CourseSerializer(many=True, read_only=True)  # For displaying courses
    
#     class Meta:
#         model = Student
#         fields = ['username', 'department_id', 'course_ids', 'courses', 'year', 'semester', 'course_category']
    
#     def create(self, validated_data):
#         course_ids = validated_data.pop('course_ids', [])
#         student = Student.objects.create(**validated_data)
        
#         # Add courses using string course IDs
#         for course_id in course_ids:
#             try:
#                 course = Course.objects.get(course_id=course_id)  # Lookup by course_id string
...
#     grade_details = serializers.SerializerMethodField(read_only=True)
...
#         from .serializers import GradeSerializer  # Import here to avoid circular imports
